...
// import { getCartByUserId, removeFromCart, updateItemQuantity, clearCart } from '../../services/operations/cartAPI';  // Import clearCart function
...
//     try {
//       await clearCart("1"); // Assuming userId is "1"
//       setCartItems([]); // Clear the cart items from the UI
//     } catch (error) {
...
//     try {
//       const updatedItem = await updateItemQuantity("1", productId, newQuantity); 
...
//             {/* Clear Cart Button */}
//             <button
//               className="bg-red-600 hover:bg-red-700 text-white w-full py-3 rounded-lg mt-4 text-lg font-medium"
